# Superseded: Branch Rebind, Reconnect Exposure, and MCP 2026-07-28 Plan

> **Superseded on 2026-09-21.** Do not execute this plan. Its principal drift fixture opens the server after checking out the target branch, so it never creates the drift it claims to test. The replacement plan is `2026-09-20-branch-reopen-reconnect-mcp-latest.md`. MCP 2026-07-28 work moved to `2026-09-21-mcp-2026-07-28-modernization.md` because protocol compatibility is independent of branch attachment.
